...
export default function QuoteFullBrief() {
  ...
  return (
    <div data-testid="page-quote" className="bg-black min-h-screen pt-28 pb-24">
      <PageMeta path="/quote/full-brief" title="Full Manufacturing Brief | Garment Foundry" description="The full 10-step Garment Foundry manufacturing brief — for projects with a tech pack and clear specifications already in hand." />
      <div className="max-w-[1280px] mx-auto px-6 lg:px-12">
        <div className="flex items-center justify-between mb-10">
          <div>
            <div className="font-body text-[10px] tracking-[0.2em] uppercase text-[#888]">FULL BRIEF</div>
            <h1 className="mt-3 font-display text-3xl lg:text-4xl text-[#F5F4F0] leading-tight">The full manufacturing brief</h1>
          </div>
