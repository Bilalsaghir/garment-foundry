      ...
      <section className="py-16 lg:py-24 px-6 lg:px-12">
        <div className="max-w-[1440px] mx-auto grid grid-cols-12 gap-8 lg:gap-16">
          ...
          <div className="col-span-12 lg:col-span-7">
            ...
            <SectionHeading eyebrow="THE WORKFLOW" number="— 001" title="A considered path to production." subtitle="Typically 8–14 weeks from approved brief to bulk despatch." />
