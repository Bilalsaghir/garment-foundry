  ...
  return (
    <div data-testid="page-not-found" className="bg-black min-h-screen pt-40 pb-32 px-6 text-center">
      ...
      <div className="max-w-xl mx-auto">
        <span className="eyebrow-number gf-fade-up">404</span>
        <h1 className="mt-6 font-display text-3xl lg:text-5xl leading-[1.1] tracking-tight text-[#F2F2F2] gf-fade-up gf-delay-200">
          This thread came loose.
        </h1>
        <p className="mt-6 font-body text-[14px] leading-[1.9] text-[#aaa] gf-fade-up gf-delay-300">
        ...
        <div className="mt-10 flex flex-col sm:flex-row gap-3 justify-center gf-fade-up gf-delay-500">
